                            ...
                            try
                            {
                                if (((DbDataReader)(object)sdr).HasRows)
                                {
                                    ...
                                    obj = new main.DashboardCount
                                    {
                                        ...
                                        ExternalOngoingProject = ((DbDataReader)(object)sdr)["ExternalOngoingProject"].ToString(),
                                        ExternalCompletedProject = ((DbDataReader)(object)sdr)["ExternalCompletedProject"].ToString(),
                                        ExternalDelayProject = ((DbDataReader)(object)sdr)["ExternalDelayProject"].ToString(),
